...
def Q_Calculate( N ,Service_Rate ,Live_Time):
    ...
    if N == 0:
        ...
        Down = (2.7 ** ((Service_Rate * Live_Time) / N)) - 1;
...
def Formola_X( N ,Entry_Rate , Service_Rate , Live_Time ):
    ...
    for i in range( 1 , N + 1 ):
        ...
        for j in range ( 1 , i + 1):
            ...
            Mult = Mult * ( Service_Rate + Q_Calculate( j , Service_Rate,  Live_Time) )
    ...
    for i in range( 1 , N + 1):
        ...
        for j in range ( 1 , i + 1):
            ...
            Down = Down * ( Service_Rate + Q_Calculate( j , Service_Rate,Live_Time) )
